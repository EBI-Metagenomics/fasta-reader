...
static struct trans const transition[][4] = {
    ...
    [FAR_FSM_SEQ_NL] = {[FAR_TOK_NL] = {FAR_FSM_SEQ_CONT, &nop},
                        ...
                        [FAR_TOK_WORD] = {FAR_FSM_ERROR, &unexpect_tok},
                        [FAR_TOK_EOF] = {FAR_FSM_END, &nop}},
    [FAR_FSM_SEQ_CONT] = {[FAR_TOK_NL] = {FAR_FSM_BEGIN, &nop},
                          [FAR_TOK_ID] = {FAR_FSM_PAUSE, &store_id},
                          [FAR_TOK_WORD] = {FAR_FSM_SEQ_NL, &seq_cont},
                          [FAR_TOK_EOF] = {FAR_FSM_END, &nop}},
    [FAR_FSM_PAUSE] = {[FAR_TOK_NL] = {FAR_FSM_SEQ_BEGIN, &nop},
                       [FAR_TOK_ID] = {FAR_FSM_DESC_BEGIN, &desc_begin},
                       [FAR_TOK_WORD] = {FAR_FSM_DESC_BEGIN, &desc_begin},
                       [FAR_TOK_EOF] = {FAR_FSM_ERROR, &unexpect_eof}},
...
static char state_name[][14] = {
    [FAR_FSM_BEGIN] = "BEGIN",         [FAR_FSM_DESC_BEGIN] = "DESC_BEGIN",
    [FAR_FSM_DESC_CONT] = "DESC_CONT", [FAR_FSM_SEQ_BEGIN] = "SEQ_BEGIN",
    [FAR_FSM_SEQ_NL] = "SEQ_NL",       [FAR_FSM_SEQ_CONT] = "SEQ_CONT",
    [FAR_FSM_PAUSE] = "PAUSE",         [FAR_FSM_END] = "END",
    [FAR_FSM_ERROR] = "ERROR",
};
